...
@pytest.mark.parametrize('buttons', [BurgerLocators.SECTION_TEXT_BREAD, BurgerLocators.SECTION_TEXT_SAUCE, BurgerLocators.SECTION_TEXT_TOPPING])
def test_success_move_to_section(driver, buttons):
