...
def test_success_login_by_button_login(driver, buttons):
...
def test_success_login_by_button_login_registration(driver):
    page = LoginPage(driver)
    page.open_main_page()
...
def test_success_login_by_button_login_recover(driver):
    page = LoginPage(driver)
    page.open_main_page()
    page.click_button(BurgerLocators.LOGIN_BUTTON_MAIN)
